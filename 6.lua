...
RevenantLib:Notification({
  Text = "西瓜脚本作者: 派微\u{e000}",
  Duration = 6,
})
wait(1)
RevenantLib:Notification({
  Text = "西瓜脚本帮助者: 派微散热器\u{e000}",
  Duration = 6,
})
wait(1)
RevenantLib:Notification({
...
local UILibrary = loadstring(game:HttpGet([[https://raw.githubusercontent.com/xiaopi77/xiaopi77/main/%E7%9A%AE%E8%84%9A%E6%9C%ACUI%E6%BA%90%E7%A0%81.lua]]))():new("西瓜脚本-派微X")
...
PlayerInfoSection:Toggle("开/关西瓜脚本用户名称显示", "Toggle", false, function(enabled)
  ...
  if enabled then
    ...
    while XM do
      ...
      textLabel.Text = "尊贵的西瓜脚本用户: " .. game.Players.LocalPlayer.DisplayName
...
AuthorInfoSection:Label("西瓜脚本")
AuthorInfoSection:Label("永不跑路的脚本")
AuthorInfoSection:Label("作者: 小西瓜")
AuthorInfoSection:Label("作者QQ: 536100056")
AuthorInfoSection:Label("tremux工具 出")
AuthorInfoSection:Label("无副群: ")
AuthorInfoSection:Label("无二群: ")
AuthorInfoSection:Label("无三群: 571553667")
AuthorInfoSection:Label("无四群: ")
...
GeneralSection:Button("西瓜飞行", function()
...
GeneralSection:Button("西瓜甩飞", function()
...
TeleportSection:Button("传送到玩家旁边", function()
  ...
  if targetPlayer and targetPlayer.Character and targetPlayer.Character.HumanoidRootPart then
    ...
    Notify("西瓜脚本", "已经传送到玩家身边", "rbxassetid://18941716391", 5)
  else
    Notify("西瓜脚本", "无法传送 原因: 玩家已消失", "rbxassetid://18941716391", 5)
  end
end)
TeleportSection:Toggle("循环锁定传送", "Loop", false, function(enabled)
  ...
  if enabled then
    ...
    Notify("西瓜脚本", "已开启循环传送", "rbxassetid://18941716391", 5)
    ...
    Notify("西瓜脚本", "已关闭循环传送", "rbxassetid://18941716391", 5)
  end
end)
TeleportSection:Button("把玩家传送过来", function()
  ...
  if targetPlayer and targetPlayer.Character and targetPlayer.Character.HumanoidRootPart then
    ...
    Notify("西瓜脚本", "已将玩家传送过来", "rbxassetid://18941716391", 5)
  else
    Notify("西瓜脚本", "无法传送 原因: 玩家已消失", "rbxassetid://18941716391", 5)
  end
end)
TeleportSection:Toggle("循环传送玩家过来", "Loop", false, function(enabled)
  ...
  if enabled then
    PlayerConfig.LoopTeleport = true
    Notify("西瓜脚本", "已开启循环传送玩家过来", "rbxassetid://", 5)
    while PlayerConfig.LoopTeleport do
      local localRootPart = game.Players.LocalPlayer.Character.HumanoidRootPart
      local targetPlayer = game.Players:FindFirstChild(PlayerConfig.playernamedied)
      if targetPlayer and targetPlayer.Character and targetPlayer.Character.HumanoidRootPart then
    ...
    PlayerConfig.LoopTeleport = false
    Notify("西瓜脚本", "已关闭循环传送玩家过来", "rbxassetid://18941716391", 5)
  end
end)
    ...
    local function ThrowPlayer(targetPlayer)
      ...
      if localCharacter and localHumanoid and localRootPart then
        ...
        elseif not targetRootPart and not targetHead and targetAccessory and accessoryHandle then
          ...
          return SendNotification("西瓜脚本", "已开/关", 5)
        end
...
r123_0:Button("FE 修改西瓜脚本天空", function()
...
r127_0:Button("西瓜脚本测试版", function()
  
  getgenv().XiaoPi = "西瓜脚本测试版QQ群1002100032"
...
local r144_0 = r50_0:Tab("『其他服务器』", "18930406865"):section("西瓜脚本-整合脚本", true)
r144_0:Button("西瓜脚本-骨折模拟器", function()
  
  loadstring(game:HttpGet("https://pastefy.app/BEvzhV3I/raw"))()
end)
r144_0:Button("西瓜脚本-鱿鱼游戏", function()
  
  loadstring(game:HttpGet("https://pastefy.app/nQXytkWG/raw"))()
end)
r144_0:Button("西瓜脚本-口渴的吸血鬼", function()
  
  loadstring(game:HttpGet("https://pastefy.app/w3IgIGwt/raw"))()
end)
r144_0:Button("西瓜脚本-骑车模拟器", function()
  
  loadstring(game:HttpGet("https://pastefy.app/VK0m90yJ/raw"))()
end)
r144_0:Button("西瓜脚本-非常容易的奥比跑酷", function()
  
  loadstring(game:HttpGet("https://pastefy.app/TfLTBjMa/raw"))()
end)
r144_0:Button("西瓜脚本-Doors but bad", function()
  
  loadstring(game:HttpGet("https://pastefy.app/3NeDK8LZ/raw"))()
end)
r144_0:Button("西瓜脚本-超简单障碍跑", function()
  
  loadstring(game:HttpGet("https://pastefy.app/HAZ1TXPS/raw"))()
end)
r144_0:Button("西瓜脚本-steep steps", function()
  
  loadstring(game:HttpGet("https://pastefy.app/zQlVSgEZ/raw"))()
end)
r144_0:Button("西瓜脚本-攀登珠穆朗玛峰模拟器", function()
  
  loadstring(game:HttpGet("https://pastefy.app/1GPELOFv/raw"))()
end)
local r146_0 = r50_0:Tab("『力量传奇』", "18930406865"):section("请到力量传奇服务器执行西瓜脚本", true)
r146_0:Label("尊敬的西瓜脚本用户您好")
r146_0:Label("请您进入力量传奇服务器执行西瓜脚本")
r146_0:Label("即可显示力量传奇服务器功能")
local r148_0 = r50_0:Tab("『极速传奇』", "18930406865"):section("请到极速传奇服务器执行西瓜脚本", true)
r148_0:Label("尊敬的西瓜脚本用户您好")
r148_0:Label("请您进入极速传奇服务器执行西瓜脚本")
...
local r152_0 = r50_0:Tab("『监狱人生』", "18930406865"):section("请到监狱人生服务器执行西瓜脚本", true)
r152_0:Label("尊敬的西瓜脚本用户您好")
r152_0:Label("请您进入监狱人生服务器执行西瓜脚本")
r152_0:Label("即可显示监狱人生服务器功能")
r50_0:Tab("『战斗勇士』", "18930406865"):section("整合脚本", true):Button("西瓜脚本-战斗勇士", function()
...
r156_0:Label("黑洞脚本合集")
r156_0:Button("「 西瓜-黑洞脚本 」『推荐使用』『可开关』『中文』", function()
...
local r159_0 = r50_0:Tab("『压力』", "18930406865"):section("请到压力服务器执行西瓜脚本", true)
r159_0:Label("尊敬的西瓜脚本用户您好")
r159_0:Label("请您进入压力服务器执行西瓜脚本")
r159_0:Label("即可显示压力服务器功能")
r50_0:Tab("『火箭发射模拟器』", "18930406865"):section("整合脚本", true):Button("西瓜脚本-火箭发射模拟器", function()
...
local r165_0 = r50_0:Tab("『河北唐县』", "18930406865"):section("请到河北唐县服务器执行西瓜脚本", true)
r165_0:Label("尊敬的西瓜脚本用户您好")
r165_0:Label("请您进入河北唐县服务器执行西瓜脚本")
...
r50_0:Tab("『造船寻宝』", "18930406865"):section("整合脚本", true):Button("西瓜脚本-造船寻宝", function()
...
r50_0:Tab("『Rooms&Doors』", "18930406865"):section("整合脚本", true):Button("西瓜脚本-Rooms&doors", function()
  
  getgenv().XiaoPi = "西瓜脚本-Rooms&doors"
...
r50_0:Tab("『汽车经销大亨』", "18930406865"):section("整合脚本", true):Button("西瓜脚本-汽车经销大亨", function()

local WindUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/Syndromehsh/Lua/refs/heads/main/西瓜/西瓜%20Wind%203.0%20UI.txt"))()
...
local Window = WindUI:CreateWindow({
    Title = "西瓜<font color='#00FF00'>2.0</font> / 被遗弃",

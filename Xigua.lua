...
about:Label("感谢所有支持西瓜中心的人")
about:Label("已修复完bug")
about:Label("♦")
about:Label("很累了    ")
about:Label("感谢大家支持西瓜中心")
about:Label("十分感谢")
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/shencongxin/vega/refs/heads/main/%E9%A3%9E%E8%A1%8C.lua"))()
end
...
about:Button("西瓜中心[云ui]",function()
